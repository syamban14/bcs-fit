...
function floatchart() {
    ...
    $(function() {
        ...
        var options = {
            ...
            colors: ["#008FFB", "#EA4D4D","#0e9e4a","#03f0fc","#ff9d00"],
            plotOptions: {
                bar: {
                    columnWidth: '65%',
                    distributed: true
            ...
            series: [{
                name: 'Attendance',
                data: [response.total,response.absent,response.working, response.izin, response.kasus_displin]
            }],
            xaxis: {
                categories: [response.total_label, response.absent_label,response.working_label, response.izin_label,response.kasus_displin_label],
            }
        };
