...
// 		}
		...
		$data = array();
          ...
          foreach($staff as $r) {						
			...
			$no_hp=$nama['telp1'];
			$sim=$nama['no_sim_b2_umum'].', '.date('d-m-Y',strtotime($nama['no_sim_b2_umum_expiredate']));
			$name = $r['payroll_id'].' - '.$namanya;
			//designation
