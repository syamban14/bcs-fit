...
$routes->get('erp/disciplinary-cases_dash/', 'Warning::case_dashboard', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
// tickets
...
$routes->get('erp/leave-list_dash/', 'Leave::leave_dash', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
...
$routes->get('erp/attendance-list-work/', 'Timesheet::attendance_work', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
$routes->get('erp/attendance-list-not_work/', 'Timesheet::attendance_not_work', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']); 
...
$routes->get('erp/tess/', 'Timesheet::tess', ['namespace' => 'App\Controllers\Erp','filter' => 'checklogin']);
// overtime request
