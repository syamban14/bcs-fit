...
if($user_info['user_type'] == 'staff'){
	...
	$category_info = $ConstantsModel->where('type','warning_type')->findAll();
        ...
        <div id="accordion">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                      <input  id="cobaan" class="form-control date" placeholder="<?= lang('Employees.xin_case_date');?>" name="warning_date" type="text">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="warning_date_to">
                    <?= lang('Employees.xin_case_date_to');?> <span class="text-danger">*</span>
                  </label>
                  <div class="input-group">
                    <input class="form-control" placeholder="<?= lang('Employees.xin_case_date');?>" name="warning_date_to" id="warning_date_to" type="text" readonly="">
                    <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                  </div>
                </div>
              </div>
